...
<header class="mdui-appbar mdui-appbar-fixed">
    <div class="mdui-toolbar mdui-color-theme">
        ...
        <a href="" class="mdui-typo-headline mdui-hidden-xs">树洞</a>
        ...
        <a href="/shudong" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: '前台首页'}"><i class="mdui-icon material-icons">&#xe88a;</i></a>
...
<div class="mdui-container main animated fadeInDown" style="padding-top: 15px;">
    <div class="mdui-m-t-5 mdui-valign">
        <h1 class="mdui-center" style="font-family: '宋体';font-size: 50px;color: #01aaed;">树洞 1.1</h1>
    </div>
</div>
